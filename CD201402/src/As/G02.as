	...
	public class G02 extends GM 
	{
		...
		private function initData():void {
			allStar = [
						...
						[[268.05, 388.65], [268.05, 455.8], [268.05, 522.95]],
						[[267.8, 186.4], [670.6, 186.4], [469.25, 119.25], [469.25, 253.55], [469.25, 320.7], [402.1, 522.15], [536.4, 522.15]]
						]
			...
			allGold = [
						...
						[[334, 455.55], [402.55, 254.15], [535.35, 522.7]],
						[[468.2, 186.3], [402.6, 254.15], [536.85, 254.15], [402.6, 321.3], [536.85, 321.3], [401.15, 388.45], [535.35, 388.45]]
						]
						
			allCh = ["a", "b", "c", "d", "e", "g", "h"];
			
			allUser = [[468.4, 390.35],[201.4, 523.65],[333.1, 255.3],[265.05, 323.85],[404.1, 389.45],[401.7, 188.85],[469.05, 389.8]]
		}
		...
		override public function EnterGame():void
		{
			...
			mapBD = new BitmapData(670, 770, true, 0);
			mapBD.draw(map_mc);
